...
2.open sentimentalAnalysis.ipynb
3.change tweetFile = pd.read_csv("") to your csv file directory
4. align csv column name with examples
5. run it

if you don't have jupyter, source code is below
...
tweetFile = pd.read_csv("D:\githubBackup\Sentiment-Analysis-of-Tweeter-Data-master\data.csv")
